        ...
        <div className="myaccomodation-container row" key={accomodation._id}>
          <div className="myaccomodation-image-container col-lg-3 col-md-3">
            <img
              ...
              src={accomodation.images?.[0]?.url || "https://images.unsplash.com/photo-1564013799919-ab600027ffc6"}
              alt={accomodation.propertyName || "Accommodation"}
            />
          </div>
          <div className="myaccomodation-information col-lg-9 col-md-9">
            ...
            <div className="stay-information">
              <span className="info">
                ...
                Check In Time: {accomodation.checkInTime || accomodation.chekInTime || "11:00 AM"}
              </span>
              <span className="material-symbols-outlined icon">
                arrow_forward
              </span>
              <span className="info">
                ...
                Check Out Time: {accomodation.checkOutTime || accomodation.chekOutTime || "12:00 PM"}
              </span>
            </div>
            <p className="myaccomodation-city">
              City: {accomodation.address?.city || "N/A"}
            </p>
            <p className="myaccomodation-guest">
              Max no of guest: {accomodation.maximumGuest || 1}
            </p>
