...
const forgotPassword = async (req, res) => {
  ...
  try {
    ...
    // The link the user will click. It points at the FRONTEND address
    const origin = process.env.ORIGIN_ACCESS_URL || "http://localhost:5173";
    ...
    try {
      ...
      console.warn("⚠️ SMTP send failed, but reset link generated:", mailError.message);
    }
